...
let website = "/error-handling"

let githubLink = "http://github.com/exira/error-handling"

// Specify more information about your project
let info =
  [ "project-name", "error-handling"
    "project-author", "exira"
    "project-summary", "F# Railway Oriented Programming Helpers"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Exira.ErrorHandling" ]
